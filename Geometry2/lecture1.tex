...
\begin{definition}[Manifold]
	Let $M$ be an open subset of $\mathbb{R}^n$, we call $M$ an \vocab{$m$-dimensional regular
...
\begin{definition}[Regular parametrized curve]
	...
	is a \vocab{regular parametrized curve}, and  $\gamma\big|_{J'}$ is
	called its \vocab{regular parametrization}.
\end{definition}
Likewise, we have:
\begin{definition}[Regular parametrizd surface]
	...
	a \vocab{regular parametrized surface}.
\end{definition}
